        ...
        <div className="flex-grow bg-base-300 w-full mt-6 px- py-4 flex justify-center items-center">
          ...
          <div className="flex flex-wrap justify-between">
            <div className="max-w-sm p-6 ml-9 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-full sm:w-1/2">
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Users that holds a score NFT with an scoring higher than 500 points can join</p>
              <Link href="/room?id=1">
            ...
            <div className="max-w-sm p-6 ml-9 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-full sm:w-1/2">
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Users that holds a score NFT with an scoring higher than 200 points can join</p>
              <Link href="/room?id=2">
                <button className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Join now
                  <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
